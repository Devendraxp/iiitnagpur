function swiper() {
        ...
        department: `
          <div class="flex justify-between py-2">
            <div class="w-[18%]">
              ...
              <h1 class="lg:py-2 md:py-[2.5px] px-4 lg:text-[1vw] md:text-[1.2vw] font-regular text-[#00457b] border-b-2 border-[#00457b]/20">
                <a href="/department/basic-science/bos">BoS</a>
              </h1>
              <h1 class="lg:py-2 md:py-[2.5px] px-4 lg:text-[1vw] md:text-[1.2vw] font-regular text-[#00457b] border-b-2 border-[#00457b]/20">
                <a href="/department/basic-science/achievements">Achievements</a>
              </h1>
              <h1 class="lg:py-2 md:py-[2.5px] px-4 lg:text-[1vw] md:text-[1.2vw] font-regular text-[#00457b] border-b-2 border-[#00457b]/20">
                <a href="/department/basic-science/research">Research</a>
              </h1>
              <h1 class="lg:py-2 md:py-[2.5px] px-4 lg:text-[1vw] md:text-[1.2vw] font-regular text-[#00457b] border-b-2 border-[#00457b]/20">
                <a href="/department/basic-science/faculty">Faculty</a>
              </h1>
              <h1 class="lg:py-2 md:py-[2.5px] px-4 lg:text-[1vw] md:text-[1.2vw] font-regular text-[#00457b] border-b-2 border-[#00457b]/20">
                <a href="/department/basic-science/staff">Staff</a>
              </h1>
              <h1 class="lg:py-2 md:py-[2.5px] px-4 lg:text-[1vw] md:text-[1.2vw] font-regular text-[#00457b] border-b-2 border-[#00457b]/20">
                <a href="/department/basic-science/projects">Projects</a>
              </h1>
              <h1 class="lg:py-2 md:py-[2.5px] px-4 lg:text-[1vw] md:text-[1.2vw] font-regular text-[#00457b] border-b-2 border-[#00457b]/20">
                <a href="/department/basic-science/laboratory">Laboratory</a>
              </h1>
              <h1 class="lg:py-2 md:py-[2.5px] px-4 lg:text-[1vw] md:text-[1.2vw] font-regular text-[#00457b] border-b-2 border-[#00457b]/20">
                <a href="/department/basic-science/events">Events</a>
              </h1>
            </div>
            <div class="w-[18%]">
      ...
      menuItems.forEach((item) => {
        item.addEventListener("click", () => {
          ...
          if (menuKey === "governance" || menuKey === "department") {
            secondBox2.innerHTML = menuContent[menuKey] || "<p>No content available.</p>";
            ...
            secondBox.innerHTML = menuContent[menuKey] || "<p>No content available.</p>";
  ...
  // .to(".text-container", { y: "-30%", duration: 1, ease: "power2.inOut", delay: 1 }) // Move 2nd h1 up
  // .to(".text-container", { y: "-56%", duration: 1, ease: "power2.inOut", delay: 1 }) // Move 3rd h1 up
  // .to(".text-container", { y: "-70%", duration: 1, ease: "power2.inOut", delay: 1 }); // Loop back to 1st 